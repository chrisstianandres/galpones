$(document).ready(function () {
    ...
    //                     $('#id_cedula').addClass("has-success").removeClass("has-error");
    //                     $('#id_cedula-error').css('display', '').html('');
    //                     return false;
    //                 } else {
    //                     alert('no');
    //                     $('#id_cedula').parent().addClass("has-error").removeClass("has-success");
    //                     $('#id_cedula-error').css('display', '').html(data['error'])
    //                 }
    //             },
