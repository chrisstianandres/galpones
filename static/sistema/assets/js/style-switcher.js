...
StyleSwitcher.prototype.build = function () {
    ...
    var h5Ai = $('<i />').addClass('fas fa-paint-roller fa-2x');
    var h5A = $('<a />').attr({
        'href': '#',
        'id': 'switcher-link'
    ...
    var h5 = $('<h5 />').html('Estilos').append(h5A);
    ...
    styleSwitcherWrap.append($('<div/>').addClass('options-link').append($('<h6/>').html('Color del texto'), fgBtnGroup));
    ...
    var resetLink = $('<a/>').html('Reiniciar estilo').attr('href', '#').on(Metis.buttonPressedEvent, function (e) {
        $this.reset();
        e.preventDefault();
    });
